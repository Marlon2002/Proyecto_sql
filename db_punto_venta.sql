...
CREATE TABLE `compras` (
  ...
  CONSTRAINT `compras_ibfk_1` FOREIGN KEY (`idproveedores`) REFERENCES `proveedores` (`idProveedores`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `compras_detalle` (
  ...
  CONSTRAINT `compras_detalle_ibfk_1` FOREIGN KEY (`idcompra`) REFERENCES `compras` (`idCompras`),
...
INSERT INTO `empleados` VALUES (1,'Marlon','Barrios','Guatemala','2002221','012321232',_binary '','2002-12-21',1,'2021-02-12','2021-02-01 11:08:32'),(3,'Pedro','Torres','Guatemala','23215454','8887782232',_binary '\0','1997-06-25',3,'2021-04-12','2021-02-03 14:01:32');
...
INSERT INTO `puestos` VALUES (1,'Supervisor'),(2,'Encargado'),(3,'Secretaria'),(4,'Tecnico'),(5,'Desarrollador');
...
CREATE TABLE `ventas` (
  ...
  CONSTRAINT `ventas_ibfk_1` FOREIGN KEY (`idcliente`) REFERENCES `clientes` (`idClientes`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
-- Dump completed on 2021-04-22 20:28:29
